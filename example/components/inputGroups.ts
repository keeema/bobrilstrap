...
function checkboxesRadioboxes(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2(
        { attrs: { id: "input-groups-checkboxes-radios" } },
...
function buttonWithDropdowns(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2(
        { attrs: { id: "input-groups-buttons-dropdowns" } },
...
function segmentedButtons(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2(
        { attrs: { id: "input-groups-buttons-segmented" } },
        "Segmented buttons"
      )
    ),
    bs.P({}, [
        ...
        bs.Col(
          ...
          bs.InputGroup({}, [
            bs.InputGroupBtn({}, [
              bs.Button(
                { aria: { label: "Bold" } },
                bs.Glyphicon({ icon: bs.GlyphIcon.Bold })
              ),
              bs.Button(
                { aria: { label: "Italic" } },
                bs.Glyphicon({ icon: bs.GlyphIcon.Italic })
              )
            ]),
            bs.InputText({
              placeholder: "Search for...",
