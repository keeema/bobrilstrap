        ...
        Object.keys(bs.GlyphIcon)
          ...
          .map(key =>
            bs.Li({}, [
              ...
              bs.Span(
                { style: styles.glyphiconClass },
                `bs.Glyphicon({ icon: bs.GlyphIcon.${bs.GlyphIcon[key]} })`
              )
            ])
          )
      )
      ...
      bs.ButtonToolbar(
        ...
        bs.ButtonGroup({}, [
          bs.Button(
            ...
            bs.Glyphicon({ icon: bs.GlyphIcon.AlignLeft })
          ),
          bs.Button(
            { aria: { label: "Center align" } },
            bs.Glyphicon({ icon: bs.GlyphIcon.AlignCenter })
          ),
          bs.Button(
            { aria: { label: "Right align" } },
            bs.Glyphicon({ icon: bs.GlyphIcon.AlignRight })
          ),
          bs.Button(
            { aria: { label: "Justify" } },
            bs.Glyphicon({ icon: bs.GlyphIcon.AlignJustify })
          )
        ])
      ),
      bs.ButtonToolbar({}, [
        bs.Button(
          { label: " Star", size: bs.Size.Lg },
          bs.Glyphicon({ icon: bs.GlyphIcon.Star })
        ),
        " ",
        bs.Button(
          { label: " Star" },
        ...
        " ",
        bs.Button(
          { label: " Star", size: bs.Size.Sm },
          bs.Glyphicon({ icon: bs.GlyphIcon.Star })
        ),
        " ",
        bs.Button(
          { label: " Star", size: bs.Size.Xs },
          bs.Glyphicon({ icon: bs.GlyphIcon.Star })
        )
      ])
    ]),
