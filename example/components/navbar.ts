        ...
        bs.Container({ fluid: true }, [
          ...
          bs.Collapse(
            ...
            bs.NavbarCollapse({}, [
              ...
              bs.Form(
                { style: [bs.navStyles.navbarForm, bs.navStyles.navbarLeft] },
                [
      ...
      bs.Navbar({}, [
        bs.Container({ fluid: true }, [
          bs.NavbarHeader({}, [
            bs.NavbarBrand(
              { href: "javascript:void(0)" },
              bs.Image({ src: imageData, width: 20, height: 20 })
            )
          ])
        ])
      ])
      ...
      bs.Navbar({}, [
        bs.Container({ fluid: true }, [
          ...
          bs.NavbarCollapse({ id: "bs-example-navbar-collapse-5" }, [
            bs.P(
              { style: [bs.navStyles.navbarText, bs.navStyles.navbarRight] },
              [
                "Signed in as ",
                bs.A(
                  {
...
function alignment(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2(
        { attrs: { id: "navbar-component-alignment" } },
        "Component alignment"
      )
    ),
    bs.P({}, [
        ...
        bs.Container({ fluid: true }, [
          ...
          bs.NavbarCollapse({ id: "bs-example-navbar-collapse-6" }, [
            bs.NavbarNav({}, [
              bs.NavbarNavItem(
                { active: true },
                bs.A({ href: "javascript:void(0)" }, "Home")
              ),
              bs.NavbarNavItem(
                {},
                bs.A({ href: "javascript:void(0)" }, "Link")
              ),
...
function fixedBottom(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2({ attrs: { id: "navbar-fixed-bottom" } }, "Fixed to bottom")
    ),
    bs.P({}, [
      `Set the `,
      bs.Code({}, "fixed"),
