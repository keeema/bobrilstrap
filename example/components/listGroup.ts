    ...
    bs.E({ style: styles.bsExample }, [
      bs.ListGroup({ linkified: true }, [
        bs.ListGroupItemLink(
          { href: "javascript:void(0)", active: true },
          "Cras justo odio"
        ),
        bs.ListGroupItemLink(
...
function disabled(): b.IBobrilChildren {
  return [
    ...
    bs.P({}, [
      `Set `,
      bs.Code({}, "disabled"),
      ` input data property to gray it out to appear disabled.`
    ]),
    bs.E({ style: styles.bsExample }, [
      bs.ListGroup({ linkified: true }, [
        bs.ListGroupItemLink(
...
function context(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2(
        { attrs: { id: "list-group-contextual-classes" } },
        "Contextual classes"
      )
    ),
    bs.E({ style: styles.bsExample }, [
...
function customContent(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2({ attrs: { id: "list-group-custom-content" } }, "Custom content")
    ),
    bs.E({ style: styles.bsExample }, [
      bs.ListGroup({ linkified: true }, [
