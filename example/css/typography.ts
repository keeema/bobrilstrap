          ...
          rows: [
            {
              columns: [
                {
                  children: bs.H1({}, [
                    "bs.H1({}, ...) Bootstrap heading ",
                    bs.Small({}, "Secondary text")
                  ])
                }
              ]
            },
...
function bodyCopy(): b.IBobrilChildren {
  return [
    ...
    bs.Figure(
      { style: styles.highlight },
      pre({}, bs.Code({ style: langJs }, "bs.P({}, ...)"))
    ),
    bs.H3({ attrs: { id: "lead-body-copy" } }, "Lead body copy"),
    bs.P({}, [
      `Make a paragraph stand out by setting `,
      bs.Code({}, "lead"),
      ` input data property.`
    ]),
    bs.E(
    ...
    bs.Figure(
      { style: styles.highlight },
      pre({}, bs.Code({ style: langJs }, "bs.P({ lead: true }, ...)"))
    )
  ];
}
...
function inlineTextElements(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2({ attrs: { id: "type-inline-text" } }, "Inline text elements")
    ),
    ...
    bs.E(
      { style: styles.bsExample },
      bs.P({}, bs.U({}, "This line of text will render as underlined."))
    ),
    bs.Figure(
      { style: styles.highlight },
      pre(
    ...
    bs.E(
      ...
      bs.P({}, [
        ...
        bs.Strong({}, "rendered as bold text"),
        "."
      ])
    ),
    bs.Figure(
    ...
    bs.E(
      ...
      bs.P({}, [
        "The following snippet of text is ",
        bs.Em({}, "rendered as italicized  text"),
        "."
      ])
    ),
    bs.Figure(
...
function transformatiomStyles(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2({ attrs: { id: "type-transformation" } }, "Transformation styles")
    ),
    bs.P({}, [
      `Easily realign text to components with text alignment classes.`
    ]),
...
function abbreviations(): b.IBobrilChildren {
  return [
    ...
    bs.P({}, [
      `Set `,
      bs.Code({}, "initialism"),
      ` input data property to an abbreviation for a slightly smaller font-size.`
    ]),
    bs.E({ style: styles.bsExample }, [
  ...
  return [
    ...
    bs.E({ style: styles.bsExample }, [
      bs.Blockquote({}, [
        ...
        bs.Footer({}, [
          "Someone famous in ",
          bs.Cite({ title: "Source Title" }, "Source Title")
        ])
      ])
    ]),
    bs.Figure(
...
function lists(): b.IBobrilChildren {
  return [
    ...
    bs.H3(
      { attrs: { id: "horizontal-description" } },
