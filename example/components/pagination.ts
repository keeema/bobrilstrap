...
function paginationDefault(): b.IBobrilChildren {
    return [
        ...
        bs.figure({ style: styles.highlight }, pre({}, bs.code({ style: langJs }, [
            ...
            `        {},`, bs.e({ tag: 'br' }),
            `        bs.a(`, bs.e({ tag: 'br' }),
            `            { href: 'javascript: void(0);', aria: { label: 'Previous' } },`, bs.e({ tag: 'br' }),
            `            bs.span({ aria: { hidden: true } }, '«')`, bs.e({ tag: 'br' }),
            `        )`, bs.e({ tag: 'br' }),
            `    ),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({}, bs.a({ href: 'javascript: void(0);' }, '1')),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({}, bs.a({ href: 'javascript: void(0);' }, '2')),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({}, bs.a({ href: 'javascript: void(0);' }, '3')),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({}, bs.a({ href: 'javascript: void(0);' }, '4')),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({}, bs.a({ href: 'javascript: void(0);' }, '5')),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem(`, bs.e({ tag: 'br' }),
            `        {},`, bs.e({ tag: 'br' }),
            `        bs.a(`, bs.e({ tag: 'br' }),
            `            { href: 'javascript: void(0);', aria: { label: 'Next' } },`, bs.e({ tag: 'br' }),
            `            bs.span({ aria: { hidden: true } }, '»')`, bs.e({ tag: 'br' }),
            `        )`, bs.e({ tag: 'br' }),
            `    ),`, bs.e({ tag: 'br' }),
            `])`, bs.e({ tag: 'br' })
        ...
        bs.figure({ style: styles.highlight }, pre({}, bs.code({ style: langJs }, [
            ...
            `        )`, bs.e({ tag: 'br' }),
            `    ),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({ active: true }, bs.a({ href: 'javascript: void(0);' }, '1')),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({}, bs.a({ href: 'javascript: void(0);' }, '2')),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({}, bs.a({ href: 'javascript: void(0);' }, '3')),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({}, bs.a({ href: 'javascript: void(0);' }, '4')),`, bs.e({ tag: 'br' }),
            `    bs.paginationItem({}, bs.a({ href: 'javascript: void(0);' }, '5')),`, bs.e({ tag: 'br' }),
...
function pager(): b.IBobrilChildren {
    return [
        ...
        bs.figure({ style: styles.highlight }, pre({}, bs.code({ style: langJs }, [
            ...
            `    bs.pagerItem({}, bs.a({ href: 'javascript: void(0);', aria: { label: 'Previous' } }, 'Previous')), ' ',`,
            bs.e({ tag: 'br' }),
            `    bs.pagerItem({}, bs.a({ href: 'javascript: void(0);', aria: { label: 'Next' } }, 'Next'))`, bs.e({ tag: 'br' }),
            `])`
        ]))),
        ...
        bs.figure({ style: styles.highlight }, pre({}, bs.code({ style: langJs }, [
            ...
            `        bs.a({ href: 'javascript: void(0);' }, [bs.span({ aria: { hidden: true } }, '←'), 'Older '])`, bs.e({ tag: 'br' }),
            `    ), `, bs.e({ tag: 'br' }),
            `    bs.pagerItem(`, bs.e({ tag: 'br' }),
            `        { alignment: bs.PagerItemAlignment.Next }, `, bs.e({ tag: 'br' }),
            `        bs.a({ href: 'javascript: void(0);' }, ['Newer ', bs.span({ aria: { hidden: true } }, ' →')])`, bs.e({ tag: 'br' }),
            `    ) `, bs.e({ tag: 'br' }),
            `]) `
        ]))),
