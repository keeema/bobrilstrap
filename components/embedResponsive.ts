...
export const embedResponsiveAspectRatioStyles: IDictionary<EmbedAspectRatio, b.IBobrilStyle> = createDictionary<
    ...
    b.IBobrilStyle
>();
embedResponsiveAspectRatioStyles(EmbedAspectRatio.SixteenByNine, embedResponsiveStyles.embedResponsive16by9);
embedResponsiveAspectRatioStyles(EmbedAspectRatio.FourByThree, embedResponsiveStyles.embedResponsive4by3);

interface IEmbedResponsiveCtx extends b.IBobrilCtx {
    data: IEmbedResponsiveData;
}

export const EmbedResponsive = b.createDerivedComponent<IEmbedResponsiveData, IBaseData>(Elem, {
