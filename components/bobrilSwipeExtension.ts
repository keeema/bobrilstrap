...
function handlePointerDown(ev: b.IBobrilPointerEvent, _target: Node, _node: b.IBobrilCacheNode): boolean {
...
function handlePointerMove(ev: b.IBobrilPointerEvent, _target: Node, _node: b.IBobrilCacheNode): boolean {
    if (ev.id === pointerId) {
...
function handlePointerUp(ev: b.IBobrilPointerEvent, _target: Node, node: b.IBobrilCacheNode): boolean {
    if (ev.id === pointerId) {
        pointerId = null;
