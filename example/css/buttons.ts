...
function buttonsTags(): b.IBobrilChildren {
    return [
        ...
        bs.P({}, [`Use the button `, bs.Code({}, "tag"), ` input data property to decide for an <a>, <button>, or <input> element`]),
...
function sizes(): b.IBobrilChildren {
    return [
        ...
        bs.P({}, [`Fancy larger or smaller buttons? Set the `, bs.Code({}, "size"), ` input data property.`]),
        bs.E({ style: styles.bsExample }, [
            bs.P({}, [
