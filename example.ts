...
b.routes(
    b.route({ handler: masterPage }, [
        b.route({ url: 'css', name: 'css', handler: css }, [
            ...
            b.route({ url: 'grid-example-mixed-complete', name: 'grid-example-mixed-complete' }),
            ...
            b.route({ url: 'tables-contextual-styles', name: 'tables-contextual-styles' }),
            ...
            b.route({ url: 'forms-control-disabled', name: 'forms-control-disabled' }),
            b.route({ url: 'forms-control-readonly', name: 'forms-control-readonly' }),
            b.route({ url: 'forms-help-text', name: 'forms-help-text' }),
            b.route({ url: 'forms-control-validation', name: 'forms-control-validation' }),
            ...
            b.route({ url: 'helper-styles-backgrounds', name: 'helper-styles-backgrounds' }),
            ...
            b.route({ url: 'helper-styles-clearfix', name: 'helper-styles-clearfix' }),
            b.route({ url: 'helper-styles-show-hide', name: 'helper-styles-show-hide' }),
            b.route({ url: 'helper-styles-screen-readers', name: 'helper-styles-screen-readers' }),
            b.route({ url: 'helper-styles-image-replacement', name: 'helper-styles-image-replacement' }),
            b.route({ url: 'responsive-utilities', name: 'responsive-utilities' }),
            b.route({ url: 'responsive-utilities-styles', name: 'responsive-utilities-styles' }),
            b.route({ url: 'responsive-utilities-print', name: 'responsive-utilities-print' }),
            b.route({ url: 'responsive-utilities-tests', name: 'responsive-utilities-tests' })
        ]),
        b.route({ url: 'bobrilstrap', name: 'bobrilstrap', handler: bobrilstrapPage }, [
            ...
            b.route({ url: 'bobrilstrap-installation', name: 'bobrilstrap-installation' }),
        ...
        b.route({ url: 'components', name: 'components', handler: components }, [
            ...
            b.route({ url: 'input-groups-checkboxes-radios', name: 'input-groups-checkboxes-radios' }),
            b.route({ url: 'input-groups-buttons', name: 'input-groups-buttons' }),
            b.route({ url: 'input-groups-buttons-dropdowns', name: 'input-groups-buttons-dropdowns' }),
            b.route({ url: 'input-groups-buttons-segmented', name: 'input-groups-buttons-segmented' }),
            b.route({ url: 'input-groups-buttons-multiple', name: 'input-groups-buttons-multiple' }),
            ...
            b.route({ url: 'navbar-component-alignment', name: 'navbar-component-alignment' }),
            ...
            b.route({ url: 'thumbnails-custom-content', name: 'thumbnails-custom-content' }),
            ...
            b.route({ url: 'list-group-contextual-classes', name: 'list-group-contextual-classes' }),
            b.route({ url: 'list-group-custom-content', name: 'list-group-custom-content' }),
