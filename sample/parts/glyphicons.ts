...
import { tag, a } from '../../utils/tags';
import { getSection } from '../containers/section';
import { getCallout } from '../containers/callout';
import { getHighlight } from '../containers/highlight';
import { getExample } from '../containers/example';
import { createAnchorLink } from '../common/anchor-link';
import { GlyphIcon } from '../../components/glyph-icons';
import { Type } from '../../components/type';
import { Size } from '../../components/size';
import { getButtonGroup } from '../../components/buttonGroup';
import { getButton } from '../../components/button';
import { getButtonToolbar } from '../../components/buttonToolbar';
...
function getGlyphIcons(): IBobrilNode {
  ...
  glyphIcons.forEach((glyphIcon: GlyphIcon) => {
