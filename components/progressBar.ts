...
progressBarContextStyles(ProgressBarContext.Danger, progressBarStyles.progressBarDanger);
...
export const progressBar = b.createDerivedComponent<IProgressBarData>(elem, {
    ...
    render(ctx: IProgressBarCtx, me: IElementBobrilNode) {
        ...
        b.style(me, ctx.data.context !== undefined && progressBarContextStyles(ctx.data.context));
