...
function disabled(): b.IBobrilChildren {
  return [
    b.anchor(
      bs.H2({ attrs: { id: "dropdowns-disabled" } }, "Disabled menu items")
    ),
    bs.P({}, [
      `Set a `,
      bs.Code({}, "disabled"),
    ...
    bs.E({ style: styles.bsExample }, [
      bs.Dropdown(
        ...
        bs.DropdownMenu({ aria: { labelledby: "dropdownMenu4" } }, [
          bs.DropdownItem(
            {},
            bs.A({ href: "javascript:void(0)" }, "Regular link")
          ),
          bs.DropdownItem(
            { disabled: true },
            bs.A({ href: "javascript:void(0)" }, "Disabled link")
          ),
          bs.DropdownItem(
            {},
            bs.A({ href: "javascript:void(0)" }, "Another link")
          )
        ])
      )
    ]),
