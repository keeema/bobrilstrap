function tag(tagName: string, children?: any[], className?: string, style?: Object, key?: string, id?: string, attrs?: Object): IBobrilNode {
...
function a(content: string, href: string, className?: string, target?: string): IBobrilNode {
