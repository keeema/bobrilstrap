...
medialContentAlignmentStyles(MediaContentAlignment.Top, mediaContentStyles.mediaTop);
medialContentAlignmentStyles(MediaContentAlignment.Middle, mediaContentStyles.mediaMiddle);
medialContentAlignmentStyles(MediaContentAlignment.Bottom, mediaContentStyles.mediaBottom);
